...
MIO_ROOM_NAMES = [
    ...
    "Stargazing",
    "Crash the Vessel",
    "Mel is the Hand's Keeper",
    "Samsk is the Hand's Keeper",
    "Rad is the Hand's Keeper",
    "Skitter Like a Buge",
    "Finding Samsk",
    "Toumtoum",
    "Above the Suns",
    ...
    "Coating Components",
    "Wildcat",
    "Halyn's Experiment #67",
    "Spill Issue",
    "Very Dangerous Red Plants",
    "Where You Come to Die",
    "Shairpin Crits",
    "Ember's Lost Boot",
    "Target Practice Plushie",
    "Nacre Drought",
    "The Eye's Favorite",
    "<REDACTED>",
    "Weave, Thread, Cut",
    ...
    "A Rat in the Vessel",
    "The Wheel",
    "For Each Voice, a Keeper",
    "For Each Keeper, a Voice",
    "You Know She Ate a Cheese",
    "Save the Heart",
    "Black Egg Library",
    "Two Betrayals",
    "You're Forgiven Now",
